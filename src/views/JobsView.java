...
public class JobsView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Insert New Jobs");

        jLabel2.setText("JOB_ID:");

        jLabel3.setText("JOB_TITLE:");
        ...
        jLabel4.setText("MIN_SALARY:");

        jLabel5.setText("MAX_SALARY:");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(tMax, javax.swing.GroupLayout.Alignment.TRAILING))))))
    ...
    private void jSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jSearchActionPerformed
        ...
        List<Jobs> act2 = irdao.search(tSearch.getText());
        DefaultTableModel model = (DefaultTableModel) jTable2.getModel();

        int count = 0;

        for (Jobs jobs : irdao.search(tSearch.getText())) {

            model.setValueAt(jobs.getJobId(), count, 0);
            model.setValueAt(jobs.getJobTitle(), count, 1);
            model.setValueAt(jobs.getMinSal(), count, 2);
            model.setValueAt(jobs.getMinSal(), count, 3);
            count = count + 1;
        }
    ...
    private void jInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jInsertActionPerformed
        ...
        Jobs jobs = new Jobs(tID.getText(),tTitle.getText() ,Integer.parseInt(tMin.getText()) , Integer.parseInt(tMax.getText()));
        
        JOptionPane.showMessageDialog(null, irdao.insert(jobs));
    ...
    private void jUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jUpdateActionPerformed
        ...
        Jobs jobs = new Jobs(tID.getText(),tTitle.getText() ,Integer.parseInt(tMin.getText()) , Integer.parseInt(tMax.getText()));
        JOptionPane.showMessageDialog(null, irdao.update(jobs));
